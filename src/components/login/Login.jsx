...
import { ValidFormData } from "../common/ValidFormData";
  ...
  return (
    <div className="min-h-screen w-screen">
      ...
      >
        <form
          onSubmit={formHandle}
          className="max-w-sm md:w-[350px] h-auto bg-black/90 text-white p-12 gap-8 flex flex-col"
        >
          ...
          <p
            ...
            className="cursor-pointer text-[13px] tracking-wide"
          >
            {isSignInForm
              ? "New to FlixGPT? Sign Up Now"
